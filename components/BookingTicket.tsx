...
const BookingTicket: React.FC<BookingTicketProps> = ({ bookingData, onDownload, onShare }) => {
  return (
      ...
      <div className="bg-[#DBE4D6] p-6 rounded-[32px]">
        ...
        <div className="space-y-6">
          <div className="text-center space-y-1">
            ...
            <p className="text-sm uppercase tracking-wider">Museum Restaurant Experience</p>
          </div>
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="flex justify-between items-center border-b border-black/10 pb-2">
              ...
              <span className="font-serif text-lg">{format(bookingData.date, 'MMMM d, yyyy')}</span>
            </div>
            <div className="flex justify-between items-center border-b border-black/10 pb-2">
              <span className="uppercase tracking-wider">Time</span>
              <span className="font-serif text-lg">{format(bookingData.date, 'h:mm a')}</span>
            </div>
            <div className="flex justify-between items-center border-b border-black/10 pb-2">
          ...
          <div className="pt-4 space-y-4">
            ...
            <div className="text-center space-y-1">
              <p className="text-xs uppercase tracking-wider text-black/60">Confirmation Code</p>
              <p className="font-mono text-lg">{bookingData.confirmationCode}</p>
            </div>
          </div>
